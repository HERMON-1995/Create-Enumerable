...
**[Create Enumerable]** Is a module to implement a subset of the functionality of Enumerable.
...
```sh
  ...
  git clone https://github.com/HERMON-1995/Create-Enumerable.git
```
...
Feel free to check the [issues page](https://github.com/HERMON-1995/Create-Enumerable/issues).
